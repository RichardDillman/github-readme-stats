...
async function run() {
  try {
    ...
    const url = `https://github-readme-stats.vercel.app/api?username=richarddillman&title_color=${titleColor}&icon_color=${iconColor}&text_color=${textColor}&bg_color=${bgColor}&show_icons=true`;
